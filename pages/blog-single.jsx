    ...
    <Layouts>
      ...
      <section className="section kf-archive-started">
        ...
        <div
          ...
          data-animate="active"
          style={{ backgroundImage: "url(home/blog1.jpg)" }}
        />
      </section>
      {/* Section Archive */}
        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-8 offset-lg-2">
              ...
              >
                <p>
                  At Lush Cafe, the food is as exceptional as the view. Our menu features a wide array of dishes that cater to diverse tastes, from local Indian flavors to global culinary delights. Each dish is crafted with fresh, high-quality ingredients, ensuring that every bite is bursting with flavor. Whether you’re in the mood for our signature ‘Lush Special Chicken Skewers’ or a refreshing drink from our extensive beverage menu, there’s something to satisfy every craving. Lush Cafe is where great taste meets great ambiance.
                </p>
                {/* <blockquote>
                  <p>
